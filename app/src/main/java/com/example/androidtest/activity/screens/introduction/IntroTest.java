...
public class IntroTest extends BaseActivity implements IntroductionContract.View{
    ...
    OnLastFragment onLastFragment = new OnLastFragment() {
        ...
        public void nextActivity() {
            Intent explicitIntent = new Intent(IntroTest.this, DressChooser.class);
            startActivity(explicitIntent);
        }

        @Override
        public void login() {
            Intent explicitIntent = new Intent(IntroTest.this, LoginActivity.class);
            startActivity(explicitIntent);
            //signIn();
        }
        ...
        public void register() {
            Intent explicitIntent = new Intent(IntroTest.this, RegisterActivity.class);
            startActivity(explicitIntent);
        }
